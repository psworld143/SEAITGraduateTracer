...
// Prepare and bind
$stmt = $conn->prepare("INSERT INTO job_postings (jobTitle, jobDescription, qualifications, applicationDeadline, contactInfo, filePath) VALUES (?, ?, ?, ?, ?, ?)");
$stmt->bind_param("ssssss", $jobTitle, $jobDescription, $qualifications, $applicationDeadline, $contactInfo, $filePath);
