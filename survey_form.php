    ...
    <form id="regForm" action="/action_page.php">
        ...
        <div class="tab">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="email" id="emailAddress" class="form-control" placeholder="Enter your email address">
                </div>
            </div>

            <div class="row mb-3">
                <label for="telephoneContact" class="col-sm-2 col-form-label">Telephone/Contact:</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="mobilePhoneNumber" class="col-sm-2 col-form-label">Mobile Phone Number:</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="regionOfOrigin" class="col-sm-2 col-form-label">Region of Origin:</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="provinceOfOrigin" class="col-sm-2 col-form-label">Province of Origin:</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" id="municipalities" class="form-control" placeholder="Enter your municipality">
                </div>
            </div>
        </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="honors3" name="honors[]" placeholder="Enter Honors/Awards"></td>
                        </tr>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="checkbox" id="undergrad_high_grades" name="undergrad_high_grades"></td>
                            <td><input type="checkbox" id="grad_high_grades" name="grad_high_grades"></td>
                        </tr>
                        <tr>
                            <td>Good grades in high school</td>
                            <td><input type="checkbox" id="undergrad_good_grades" name="undergrad_good_grades"></td>
                            <td><input type="checkbox" id="grad_good_grades" name="grad_good_grades"></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="checkbox" id="grad_parent_influence" name="grad_parent_influence"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" id="undergrad_role_model" name="undergrad_role_model"></td>
                            <td><input type="checkbox" id="grad_role_model" name="grad_role_model"></td>
                        </tr>
                        <tr>
                            <td>Strong passion for the profession</td>
                            <td><input type="checkbox" id="undergrad_passion" name="undergrad_passion"></td>
                            <td><input type="checkbox" id="grad_passion" name="grad_passion"></td>
                        </tr>
                        <tr>
                            <td>Prospect for immediate employment</td>
                            <td><input type="checkbox" id="undergrad_employment" name="undergrad_employment"></td>
                            <td><input type="checkbox" id="grad_employment" name="grad_employment"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" id="undergrad_availability" name="undergrad_availability"></td>
                            <td><input type="checkbox" id="grad_availability" name="grad_availability"></td>
                        </tr>
                        <tr>
                            <td>Prospect of career advancement</td>
                            <td><input type="checkbox" id="undergrad_advancement" name="undergrad_advancement"></td>
                            <td><input type="checkbox" id="grad_advancement" name="grad_advancement"></td>
                        </tr>
                        <tr>
                            <td>Affordable for the family</td>
                            <td><input type="checkbox" id="undergrad_affordable" name="undergrad_affordable"></td>
                            <td><input type="checkbox" id="grad_affordable" name="grad_affordable"></td>
                        </tr>
                        <tr>
                            <td>Prospect of attractive compensation</td>
                            <td><input type="checkbox" id="undergrad_compensation" name="undergrad_compensation"></td>
                            <td><input type="checkbox" id="grad_compensation" name="grad_compensation"></td>
                        </tr>
                        <tr>
                            <td>Opportunity for employment abroad</td>
                            <td><input type="checkbox" id="undergrad_abroad" name="undergrad_abroad"></td>
        ...
        <div class="tab">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="yes" name="yes" value="regular">
                        <label class="form-check-label" for="yes">Yes</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="no" name="no" value="temporary">
            ...
            <div class="question">
                ...
                <div class="checkbox-group">
                    ...
                    <label for="competencies-human-relations"><input type="checkbox" id="competencies-human-relations"
                            name="useful_competencies[]" value="human_relations"> Human Relations skills</label>
                    <label for="competencies-entrepreneurial"><input type="checkbox" id="competencies-entrepreneurial"
                            name="useful_competencies[]" value="entrepreneurial"> Entrepreneurial skills</label>
                    ...
                    <label for="competencies-problem-solving"><input type="checkbox" id="competencies-problem-solving"
                            name="useful_competencies[]" value="problem_solving"> Problem-solving skills</label>
            ...
            <div class="row mb-3">
                <label for="curriculum-improvement">List down suggestions to further improve your course
                    curriculum:</label>
                <div class="col-sm-10">
            ...
            <div class="question">
                ...
                <div class="checkbox-group">
                    ...
                    <input type="text" id="values-learned-other" name="values_learned_other" placeholder="Other values">
                </div>
            </div>
